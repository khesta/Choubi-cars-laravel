...
@section('content')
    <div class="mx-auto max-w-screen-xl">
        ...
        <div id="reservations" class="mt-12">
            <div id="reservations" class="mt-12 bg-red-100">
                <div class="flex align-middle justify-center items-center">
                    <hr class="mt-8 h-0.5 w-1/2 bg-red-500">
                    <p class="my-2 mx-8 p-2 font-car font-bold text-red-500 text-lg">Admins</p>
                    <hr class="mt-8 h-0.5 w-1/2 bg-red-500">
                    <a href="{{ route('addAdmin') }}"
                       class="flex w-40 border-2 border-red-500 text-red-500 hover:text-white hover:bg-red-600 font-car font-medium p-1 rounded-md transition-colors duration-300">
                       <button class="text-red-500 hover:bg-red-500 hover:text-white transition duration-300 ease-in-out px-4 py-2 rounded">
                        Add New Admin
                      </button>
        ...
        <div id="reservations" class="mt-12">
            <div class="flex align-middle justify-center">
                ...
                <p class="my-2 mx-8 p-2 font-car font-bold text-red-500 text-lg">Clients</p>
                <hr class=" mt-8 h-0.5 w-1/2 bg-pr-500">
                <hr>
            </div>
