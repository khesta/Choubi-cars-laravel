            ...
            <form action="#" class="space-y-8" id="contact-form">
                ...
                <div class="flex justify-between">
                    <div class="w-full mr-5">
                        ...
                        <input type="email" id="email"
                            class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500 dark:shadow-sm-light"
                            placeholder="choaibbelghazzar.ce@gmail.com" required>
                    </div>
                ...
                <button type="submit"
    class="p-3 mb-16 font-bold border rounded-md border-red-500 text-red-500 hover:text-white hover:bg-red-600">
    Send message
</button>
            </form>
        </div>
        <div class="grid mx-auto text-center gap-4 ">
            <div>
                ...
                <p class="text-sm font-light text-gray-700 font-car">Choubi Cars LLC</p>
                <p class="text-sm font-light text-gray-700 font-car">Location: Morocco MOHAMMEDIA</p>
            </div>
            <div>
                <div class="w-20 p-6 mx-auto mb-3 bg-gray-200 rounded-md ">
                    <svg id="o" xmlns="http://www.w3.org/2000/svg" height="2em" viewBox="0 0 512 512">
                ...
                <p class="text-sm font-light text-gray-700 font-car">Bradaa rue 5 nr 488 MOHAMMEDIA </p>
            ...
            <div>
                ...
                <p class="text-red-500 hover:text-red-600 transition-colors duration-200">+212600000000</p>
            </div>
