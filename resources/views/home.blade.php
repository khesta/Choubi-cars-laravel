...
@section('content')
        ...
        <div class="bg-sec-100 ">
            ...
            <div class="flex justify-center md:py-28 py-12 mx-auto max-w-screen-xl">
                <div class="flex  flex-col justify-center md:w-3/5  mx-12 md:ms-20 md:mx-0">
                    <h1 class=" md:text-start text-center  font-car font-bold text-gray-900 mb-8  md:text-7xl text-4xl "><span class="text-red-500"> Renting
                        </span> your dream car has never been easier. Welcome!</h1>
                    ...
                    <p class="text-justify md:mx-0 mx-8 "></p>
                    <div class="flex justify-center md:justify-start mt-12 md:w-2/3 me-12 md:-ms-12">
                        <div class="flex items-center">
                            <div class="flex flex-wrap gap-4 justify-center md:justify-start">
                                <a href="/cars" class="inline-block">
                                    <button class="bg-red-600 hover:bg-red-700 text-white font-semibold py-2 px-6 rounded-lg shadow-md transition-all duration-200 ease-in-out transform hover:scale-[1.02] border-2 border-transparent hover:border-red-800 w-32">
                                        CARS
                                    </button>
                                </a>
                                <a href="/contact_us" class="inline-block">
                                    <button class="bg-red-600 hover:bg-red-700 text-white font-semibold py-2 px-6 rounded-lg shadow-md transition-all duration-200 ease-in-out transform hover:scale-[1.02] border-2 border-transparent hover:border-red-800 w-32">
                                        CONTACT US
                                    </button>
                                </a>
                ...
                <div class="md:w-3/5 hidden md:block  ">
                    <img loading="lazy" src="/images/home-car.jpg" alt="home car">
                </div>
            ...
            <div class="mx-auto max-w-screen-xl">
                <div class="flex align-middle justify-center">
                    ...
                    <p class="my-4 mx-8 p-3 font-car font-bold text-red-600 text-xl tracking-wide
                    bg-white bg-opacity-90 rounded-lg shadow-sm
                    transition-all duration-200 hover:text-red-700 hover:shadow-md">
             CARS
         </p>
                    <hr class=" mt-8 h-0.5 w-2/5 bg-pr-500">
                    <hr>
                ...
                <div class="   md:mr-16 mr-4 mb-4 flex justify-end">
                    <a href="/cars">
                        <button class="flex items-center justify-center gap-2 bg-red-600 text-white w-28 py-2 px-4
              rounded-lg border-2 border-red-600 hover:bg-red-700 hover:border-red-700
                ...
                @foreach ($cars as $car)
                    <div
                        ...
                        <a class="relative mx-3 mt-3 flex h-60 overflow-hidden rounded-xl" href="{{ route('car.reservation', ['car' => $car->id]) }}">
                            ...
                            <span class="absolute top-0 left-0 m-2 rounded-full bg-red-600 px-2 py-1 text-center text-xs font-bold text-white shadow-md transition-transform duration-200 hover:scale-105 hover:bg-red-700">
                                {{ $car->reduce }}% OFF
                            </span>
                        </a>
                        <div class="mt-4 px-5 pb-5">
                            ...
                            <div class="mt-2 mb-5 flex items-center justify-between">
                                <p>
                                    <span class="text-3xl font-bold text-slate-900">{{number_format($car->price_per_day,0)}} DH</span>
   ...
   class="flex items-center justify-center rounded-md bg-red-600 hover:bg-red-700 px-5 py-2.5 text-sm font-medium text-white shadow-md transition duration-200">
    <svg class="mr-2 h-5 w-5 fill-white" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
        <path
    ...
    Reserve
            ...
            <div class="mx-auto max-w-screen-xl mt-16 mb-32">
                <div>
                    <h2 class="text-center font-car text-3xl font-medium">
                        <span class="text-gray-900">Our</span>
                        <span class="text-red-500">Numbers</span>
                    </h2>
                </div>
                <div
            ...
            <div class="mx-auto max-w-screen-xl ">
                <div>
                    <h2 class="text-center font-car text-3xl font-medium">
                        ...
                        <span class="text-red-500">Choose us</span>
                    </h2>
                </div>
            ...
            <div class=" relative -bottom-[1px] mx-auto max-w-screen-xl  ">
                <img src="{{ asset('images/location img.jpg') }}" alt="Description de l'image">
